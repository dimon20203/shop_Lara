    ...
    <header class="edica-header edica-landing-header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="index.html"><img src="{{ asset('assets/images/logo.svg') }}" ></a>
                       ...
                       <div class="carousel-item active">
                           <div class="row">
                               ...
                               <div class="col-md-6 carousel-img-wrapper">
                                   <img src="{{ asset('assets/images/Slider_1.png') }}" >
                               </div>
                           </div>
                       </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6" data-aos="fade-up-left">
                        <img src="{{ asset('assets/images/phone-copy.png') }}" >
                    </div>
                </div>
            </div>
        </section>
        <section class="edica-landing-section edica-landing-clients">
            <div class="container">
                ...
                <div class="partners-wrapper">
                    <img src="{{ asset('assets/images/Partner_1.png') }}" >
                    <img src="{{ asset('assets/images/Partner_2.png') }}" >
                    <img src="{{ asset('assets/images/Partner_3.png') }}" >
                    <img src="{{ asset('assets/images/Partner_4.png') }}" >
                    <img src="{{ asset('assets/images/Partner_5.png') }}" >
                    <img src="{{ asset('assets/images/Partner_6.png') }}" >
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 landing-service-card" data-aos="fade-left">
                        <img src="{{ asset('assets/images/internet.svg') }}" >
                        <h4 class="service-card-title">Secure and Reliable</h4>
                        <p class="service-card-description">He has led a remarkable campaign, defying the traditional mainstream parties courtesy of his En Marche! movement. For many, however, the.</p>
                    </div>
                    <div class="col-md-6 landing-service-card" data-aos="fade-right">
                        <img src="{{ asset('assets/images/goal.svg') }}" >
                        <h4 class="service-card-title">Fast. Instantly.</h4>
                        <p class="service-card-description">He has led a remarkable campaign, defying the traditional mainstream parties courtesy of his En Marche! movement. For many, however, the.</p>
                    </div>
                    <div class="col-md-6 landing-service-card" data-aos="fade-left">
                        <img src="{{ asset('assets/images/chat-bubble.svg') }}" >
            ...
            <div class="container">
                <div id="edicaLandingTestimonialCarousel" class="carousel slide landing-testimonial-carousel" data-ride="carousel">
                    <div class="text-center py-4">
                        <img src="{{ asset('assets/images/quote.svg') }}" >
                    </div>
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item">
                    ...
                    <ol class="carousel-indicators">
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="0">
                            <img src="{{ asset('assets/images/oval-copy-3.png') }}" >
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="1">
                            <img src="{{ asset('assets/images/oval-copy-4.png') }}" >
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="2" class="active">
                            <img src="{{ asset('assets/images/oval.png') }}" >
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="3">
                            <img src="{{ asset('assets/images/oval-copy.png') }}" >
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="4">
                            <img src="{{ asset('assets/images/oval-copy-2.png') }}" >
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 landing-blog-post" data-aos="fade-right">
                        <img src="{{ asset('assets/images/rectangle.png') }}" >
                    ...
                    <div class="col-md-4 landing-blog-post" data-aos="fade-up">
                        <img src="{{ asset('assets/images/rectangle-copy.png') }}" >
                        <p class="blog-post-category">Blog post</p>
                        <h4 class="blog-post-title">Check our latest blog post for more update.</h4>
                        <a href="#!" class="blog-post-link">Learn more</a>
                    </div>
                    <div class="col-md-4 landing-blog-post" data-aos="fade-left">
                        <img src="{{ asset('assets/images/rectangle-copy-2.png') }}" >
                        <p class="blog-post-category">Blog post</p>
                        <h4 class="blog-post-title">Check our latest blog post for more update.</h4>
                        <a href="#!" class="blog-post-link">Learn more</a>
                    </div>
        ...
        <div class="container">
            <div class="footer-banner" data-aos="fade-up">
                ...
                <div class="banner-btns-wrapper">
                    <button class="btn btn-success"> <img src="{{ asset('assets/images/apple@1x.svg') }}" > App Store</button>
                    <button class="btn btn-success"> <img src="{{ asset('assets/images/android@1x.svg') }}" > Google Play</button>
                </div>
